  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#7f4634]">
      ...
      {enteredSite && (
        ...
        >
          <div className="pointer-events-none absolute -left-24 top-24 h-72 w-72 rounded-full bg-[#C86F4A]/10 blur-3xl" />
          <div className="pointer-events-none absolute -right-24 bottom-24 h-80 w-80 rounded-full bg-[#D77A57]/10 blur-3xl" />

          <div className="relative mx-auto max-w-6xl">

            {/* EN-TÊTE */}
            <div className="mx-auto mb-16 max-w-3xl text-center">
              <p className="mb-4 text-xs uppercase tracking-[0.45em] text-[#C54716]">
                Notre mariage
              </p>

              <h2 className="font-serif text-5xl text-[#4A2924] md:text-7xl">
                Le programme
              </h2>

              <div className="mx-auto my-7 h-px w-20 bg-[#D77A57]" />

              <p className="mx-auto max-w-xl text-base leading-7 text-[#755B54] md:text-lg">
                Deux journées, des instants précieux et une seule histoire à célébrer
            ...
            <div className="mx-auto max-w-4xl">
              ...
              <div className="mt-10 relative overflow-hidden rounded-[32px] border border-[#E4C6B8]/40 bg-[#FFF9F3] px-8 py-11 text-center shadow-[0_20px_60px_rgba(83,46,35,0.08)] md:px-16">
                <div className="mb-5 text-2xl text-[#D77A57]">
                  ♡
                </div>

                <p className="mb-3 text-xs uppercase tracking-[0.35em] text-[#C54716]">
                  Dote • Mairie
                </p>

                <h4 className="mb-5 font-serif text-3xl text-[#4A2924] md:text-4xl">
                  Une première journée pleine d’émotions
                </h4>

                <p className="mx-auto max-w-xl leading-7 text-[#755B54]">
                  Les détails de cette première journée seront bientôt dévoilés.
                  Rendez-vous ici très prochainement pour découvrir le programme.
                </p>

                <div className="mx-auto mt-7 h-px w-16 bg-[#D77A57]/70" />

                <p className="mt-5 font-serif italic text-[#9F4728]">
                  Encore un peu de patience…
                </p>
              </div>
            </div>

            {/* TRANSITION ENTRE LES 2 JOURS */}
            <div className="mx-auto flex max-w-xl items-center gap-5 px-8 py-14 md:py-16">
              <div className="h-px flex-1 bg-[#D77A57]/35" />

              <span className="font-serif text-2xl text-[#C54716]">
                ♡
              </span>
            ...
            <div className="mx-auto max-w-4xl">
              ...
              ========================== */}
              <div className="mx-auto mt-14 max-w-4xl px-0 pb-10 md:mt-16">

                <div className="mx-auto h-12 w-px bg-[#D77A57]" />

                <div className="relative overflow-hidden rounded-[34px] border border-[#E7CABB] bg-[#FFF9F5] px-8 py-12 text-center shadow-[0_18px_60px_rgba(113,63,47,0.08)] md:px-16 md:py-14">

                  <div className="absolute -right-12 -top-12 h-32 w-32 rounded-full bg-[#C54716]/5" />
                  <div className="absolute -bottom-16 -left-16 h-40 w-40 rounded-full bg-[#D77A57]/5" />
                  ...
                  <div className="relative">
                    ...
                    <h3 className="mt-5 font-serif text-4xl text-[#542E26] md:text-5xl">
                      Green Garden
                    </h3>

                    <div className="mx-auto my-6 h-px w-14 bg-[#D77A57]" />

                    <p className="text-lg text-[#72574F]">
                      Yaoundé · Odza
                    </p>

                    <p className="mt-1 text-sm text-[#9A7C72]">
                      Immeuble HAPPY
                    </p>

                    <a
                      href="https://www.google.com/maps/search/?api=1&query=Green+Garden+Odza+Yaounde"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="mt-8 inline-flex items-center justify-center rounded-full bg-[#C54716] px-9 py-4 text-[11px] uppercase tracking-[0.28em] text-white transition duration-300 hover:-translate-y-1 hover:bg-[#A95846] hover:shadow-lg"
                    >
                      Voir l’itinéraire
                    </a>

                    <p className="mt-8 font-serif text-base italic text-[#B84A20]">
              ...
              <div className="mt-10 text-center">
                <span className="text-2xl text-[#D77A57]">
                  ♡
                </span>

                <p className="mt-4 font-serif text-lg italic text-[#8E6258]">
                  Deux cœurs, une histoire, une journée inoubliable.
                </p>
              </div>
            </div>
          </div>
